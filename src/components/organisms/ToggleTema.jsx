        ...
        <Container>
            <div className="container">
                <label className="toggle">
                    <input id="switch" className="input" type="checkbox" onClick={setTheme} />
